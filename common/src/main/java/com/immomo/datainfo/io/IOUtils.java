...
public class IOUtils {
    ...
    public static void copyBytes(InputStream in, OutputStream out, Configuration conf)
            throws IOException {
        copyBytes(in, out, conf.getInt(CommonConfigurationKeys.IO_FILE_BUFFER_SIZE, CommonConfigurationKeys.IO_FILE_BUFFER_SIZE_DEFAULT), true);
    }
    ...
    public static void copyBytes(InputStream in, OutputStream out, Configuration conf, boolean close)
            throws IOException {
        copyBytes(in, out, conf.getInt(CommonConfigurationKeys.IO_FILE_BUFFER_SIZE, CommonConfigurationKeys.IO_FILE_BUFFER_SIZE_DEFAULT),  close);
    }
