...
public class RPC {
    ...
    public enum RpcKind {
        ...
        RPC_PROTOCOL_BUFFER ((short) 2); // Use ProtobufRpcEngine
    ...
    interface RpcInvoker {
         ...
         * @throws IOException
         **/
        public RpcWrapper call(Server server, String protocol,
                             RpcWrapper rpcRequest, long receiveTime) throws Exception ;
    }
        ...
        while (true) {
            try {
                return getProtocolProxy(protocol, clientVersion, addr, conf,
                        NetUtils.getDefaultSocketFactory(conf), rpcTimeout, connectionRetryPolicy);
    ...
    public static <T> ProtocolProxy<T> getProtocolProxy(Class<T> protocol,
                                                        ...
                                                        InetSocketAddress addr, Configuration conf,
                                                        SocketFactory factory) throws IOException {
        LOG.info("SocketFactory:" + factory.toString());
    ...
    public static <T> ProtocolProxy<T> getProtocolProxy(Class<T> protocol,
            ...
            throws IOException {
        LOG.info(RPC.getProtocolName(protocol));
    ...
    public static class Builder {
         ...
         * @throws AvalonIllegalArgumentException when mandatory fields are not set
         */
        public Server build() throws IOException, AvalonIllegalArgumentException {
            if (this.conf == null) {
                throw new AvalonIllegalArgumentException("conf is not set");
            }
            if (this.protocol == null) {
                throw new AvalonIllegalArgumentException("protocol is not set");
            }
            if (this.instance == null) {
                throw new AvalonIllegalArgumentException("instance is not set");
            }
    ...
    /** An RPC Server. */
    public abstract static class Server extends com.immomo.datainfo.rpc.Server {
        boolean verbose;
        ...
        void registerProtocolAndImpl(RpcKind rpcKind, Class<?> protocolClass,
            ...
            LOG.info("RpcKind = " + rpcKind + " Protocol Name = " + protocolName +  " version=" + version +
        ...
        @Override
        public RpcWrapper call(RpcKind rpcKind, String protocol,
                             RpcWrapper rpcRequest, long receiveTime) throws Exception {
