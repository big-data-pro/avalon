...
import com.immomo.datainfo.util.SecurityUtil;
...
import com.immomo.datainfo.rpc.VersionedProtocol;
import com.immomo.datainfo.rpc.Server;
...
public class NetUtils {
    ...
    public static SocketFactory getSocketFactory(Configuration conf,
        ...
        String propValue =
                conf.get("avalon.rpc.socket.factory.class." + clazz.getSimpleName());
    ...
    public static SocketFactory getDefaultSocketFactory(Configuration conf) {
        ...
        String propValue = conf.get(
                CommonConfigurationKeys.AVALON_RPC_SOCKET_FACTORY_CLASS_DEFAULT_KEY,
                CommonConfigurationKeys.AVALON_RPC_SOCKET_FACTORY_CLASS_DEFAULT_DEFAULT);
        if ((propValue == null) || (propValue.length() == 0))
